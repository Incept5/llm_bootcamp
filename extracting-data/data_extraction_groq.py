...
def extract(text, what):
    prompt = f"You are a concise data extraction assistant. Extract {what} from the following text, give the answer only, nothing else...\n{text}"
    return generate_response(prompt)
...
def main():
    ...
    * max_tokens: 40960
    ...
    num_payments = extract(text, data)
    print(f"{data}: {num_payments}")
